...
public class Function {
	...
	public String Page(String sPage, ResultSet rs, int intPage, int intPageSize) {
		...
		try {
			...
			if (intRowCount > intPageSize) {
				...
				s = s + "褰撳墠绗�" + intPage + "椤�/鍏�" + intPageCount
						+ "椤�,&nbsp;&nbsp;&nbsp;&nbsp;鍏�" + intRowCount
						+ "鏉¤褰�,&nbsp;&nbsp;&nbsp;&nbsp;" + intPageSize + "鏉�/椤�";
	...
	public String OutError(String s) {
		try {
			...
			sb
					.append("<div align=\"center\" class=\"title\">閿欒椤甸潰</div></td></tr>\r\n");
			sb
			...
			sb
					.append("<p align=\"left\"><span class=\"info1\">鎿嶄綔鍑洪敊锛�</span></p><div align=\"left\" class=\"info1\">");
			...
			sb
					.append("<a href=\"#\" onClick=\"javascript:history.go(-1)\">杩斿洖</a></div></td></tr></table></td></tr></table><br><br>\r\n");
			return sb.toString();
		} catch (Exception e) {
		}
		return "鎿嶄綔鍑洪敊!";
	...
	public String OutWarn(String s) {
		try {
			...
			sb.append("<div align=\"left\" class=\"info1\">绯荤粺璀﹀憡锛�<br><br>\r\n");
			sb.append("&nbsp;&nbsp;&nbsp;&nbsp;");
			sb.append(s);
			sb.append("</div></td></tr>\r\n");
			sb
			...
			sb
					.append("<input name=\"Submit\" type=\"button\" class=\"button\" value=\"鍙栨秷\" onClick=\"javascript:history.go(-1);\">&nbsp;&nbsp;\r\n");
			sb
					.append("<input name=\"OK\" type=\"hidden\" id=\"OK\" value=\"Yes\">\r\n");
			sb
					.append("<input name=\"Submit2\" type=\"submit\" class=\"button\" value=\"纭畾\">\r\n");
			sb.append("</div></td>\r\n");
